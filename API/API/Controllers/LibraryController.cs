...
namespace API.Controllers
{
    ...
    public class LibraryController : ControllerBase
    {
        ...
        {
            if (Context.Users.Any(u => u.Email.Equals(loginInfo.email) && u.Password.Equals(loginInfo.password)))
            {
                var user = Context.Users.Single(user => user.Email.Equals(loginInfo.email) && user.Password.Equals(loginInfo.password));
